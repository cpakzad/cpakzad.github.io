...
## Scientific articles
- S. Girard and C. Pakzad (2024). *Functional Extreme Partial Least-Squares*. Preprint. Code in Python (Jupyter notebook) available [here][1]
- [1]:{{ https://github.com/cpakzad/cpakzad.github.io/ }}/download/FEPLS.zip
